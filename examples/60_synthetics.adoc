...
[source,shell]
----
http PUT localhost:8080/api/v1alpha1/things/default/things/foo/syntheticStates/temperature_f javaScript=@60_synthetics/syn2.js
----
...
[source,shell]
----
http PUT localhost:8080/api/v1alpha1/things/default/things/foo/syntheticStates/add javaScript=@60_synthetics/syn3.js
