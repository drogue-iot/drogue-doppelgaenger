...
http PUT localhost:8080/api/v1alpha1/things/default/things/A4:C1:38:0A:88:A8/reconciliations 'changed[overTempGroup][script]=@20_reconcile/recon2.js'
http PUT localhost:8080/api/v1alpha1/things/default/things/A4:C1:38:A2:6D:42/reconciliations 'changed[overTempGroup][script]=@20_reconcile/recon2.js'
----
